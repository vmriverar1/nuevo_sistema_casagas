...
<div class="modal fade" id="modal-users" class="modal-dom" tabindex="-1" role="dialog"
    aria-labelledby="modal-users-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-users-title">Modal usuario</h5>
                ...
                <form action="#">
                    <div class="wizard">
                        ...
                        <section>
                            ...
                            <div class="form-group">
                                <input type="password" name="password" placeholder="Contraseña" class="form-control password" required>
                            </div>

                            <div class="form-group">
                                <input type="password" name="verify-password" placeholder="Verificar Contraseña" class="form-control verify-password" required>
                            </div>

                            <div class="mb-4">
                                <select class="form-control" name="role" required>
                                    <option value="No asignado" selected disabled>Selecciona rol</option>
