...
<div class="modal fade" id="modal-suppliers" class="modal-dom" tabindex="-1" role="dialog"
    aria-labelledby="modal-suppliers-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-suppliers-title">Modal usuario</h5>
